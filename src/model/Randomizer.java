...
public class Randomizer {
    ...
    public void generetaData() {
        ...
        do{
             ...
             Verkeerstoren actor3 = random3.setVerkeersToren(Hulpdiensten.VERKEERSTOREN,coördinaten, geenStrategy); //eerst verkeerstoren genereren zodat schepen zich kunnen registeren
             actoren.add(actor3);
             actoren.add(actor3);
             ++teller2;
        ...
        do {
            ...
            //actor.notifyVerkeerstorenObservers(StatusVoetuig.OK.toString());   //Alles mogelijke statussen bevinden zich in de enum StatusVoertuig.
